...
local controls = {
    ...
    btnOpenHelpSources  = Controls.btnOpenHelpSources,
    ...
    btnCloseHelpSources = Controls.btnCloseHelpSources,
...
local function validateControls()
    ...
    local optional = {
        ...
        "btnOpenHelpLaptop", "btnOpenHelpPC", "btnOpenHelpWireless", "btnOpenHelpRouting", "btnOpenHelpSources",
        "btnCloseHelpLaptop", "btnCloseHelpPC", "btnCloseHelpWireless", "btnCloseHelpRouting", "btnCloseHelpSources",
...
local function normalizeControlArrays()
    ...
    local helpButtons = {"btnOpenHelpLaptop", "btnOpenHelpPC", "btnOpenHelpWireless", "btnOpenHelpRouting", "btnOpenHelpSources",
    "btnCloseHelpLaptop", "btnCloseHelpPC", "btnCloseHelpWireless", "btnCloseHelpRouting", "btnCloseHelpSources"}
...
function LayerModule:showLayer()
    ...
    local layersToHide = {
        ...
        "H01-RoomControls", 
        "I01-CallActive", "I02-HelpLaptop", "I03-HelpPC","I04-HelpWireless", "I05-HelpRouting", "I07-HelpSources",
    ...
    local layerConfigs = {
        ...
        [self.controller.kLayerSources] = {
            showLayers = {"S05-Sources"},
            callLayerFunctions = {
                function() self.controller.sublayerModule:updateSourcesHelpState() end,
                function() self.controller.sublayerModule:updateCallActiveState() end
            }
        }
    }
...
function SublayerModule:updateSourcesHelpState()
    local isVisible = controls.btnOpenHelpSources and controls.btnOpenHelpSources.Boolean or false
    self.controller.layerModule:updateLayerVisibility({"I07-HelpSources"}, isVisible, "none")
    self:debug("Stream Music Help: " .. (isVisible and "Showing" or "Hiding") .. " I07-HelpSources")
end
...
function UCIController:registerEventHandlers()
    ...
    local helpControlPairs = {
        ...
        {open = controls.btnOpenHelpSources, close = controls.btnCloseHelpSources, handler = function() self.sublayerModule:updateSourcesHelpState() end}
    }
...
function UCIController:initializeLegendArrays()
    ...
    local legendControls = {
        ...
        "txtRoutingRooms01", "txtRoutingRooms02", "txtWallSources",
    ...
    local userLabelVariables = {
        ...
        "txtLabelRoutingRooms01", "txtLabelRoutingRooms02","txtLabelWallSources",
