--[[
  Samsung DisplayController (Refactored) - Q-SYS Control Script
  Controls Samsung displays plugin v.1.5 with power management and input switching
...
local inputButtonMap = {
    ...
    DisplayPort1= 5, DisplayPort2 = 6, DisplayPort3 = 7, DTV = 8, S_Video = 9, Component = 10
}
