...
local function registerEventHandlers()
  ...
  local enableCheckTimer = Timer.New()
  enableCheckTimer:Start(checkAndEnableAtTimeConfig, 60)
  print("Time of Day enable check timer started (60s interval)")
end
